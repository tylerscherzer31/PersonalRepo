...
export class AcademicEditor extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            formData: {
                id: props.academicCourse.id || "",
                description: props.academicCourse.description || "", 
                semester: props.academicCourse.semester || "", 
                prefix: props.academicCourse.prefix || "",
                number: props.academicCourse.number || "",
                grade: props.academicCourse.grade || "",
            }
        }
    }
